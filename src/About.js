function About() {
  return (
    <div id="about">
      <h2>About</h2>
      <img src="/portfolio/images/headshot.jpg" alt="Aruna Evan" className="headshot"/>
      ...
      <p><em><strong>Tech Stack:</strong> React, Ruby on Rails, Javascript, CSS, HTML, Redux, Apollo (GraphQL), Heroku, PostgreSQL, Redis, Active Record, SQLite, SQL, Git</em></p>
    </div>
  );
}

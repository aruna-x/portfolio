    ...
    <div id="projects">
        ...
        <div id="project-wrapper">
            <div className="project-card flex-one">
                <img className="project-img" src="/portfolio/images/350.png" alt="Preview of fundraising site" />
            ...
            <div className="project-card flex-one">
                <img className="project-img" src="/portfolio/images/quiz-game.png" alt="Preview of quiz game app" />
            ...
            <div className="project-card flex-one">
                <img className="project-img" src="/portfolio/images/calculator.png" alt="Preview of Big O calculator app" />
            ...
            <div className="project-card flex-one">
                <img className="project-img" src="/portfolio/images/med-reminders.png" alt="Preview of med reminder project" />
                <h3>Med Reminders</h3>
